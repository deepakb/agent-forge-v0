  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        'body-2xl': ['1.5rem', { lineHeight: '1.4', letterSpacing: '-0.01em' }],
        'body-xl': ['1.25rem', { lineHeight: '1.5', letterSpacing: '-0.01em' }],
        'body-lg': ['1.125rem', { lineHeight: '1.5' }],
        'body-md': ['1rem', { lineHeight: '1.5' }],
        'body-sm': ['0.875rem', { lineHeight: '1.5' }],
        'body-xs': ['0.75rem', { lineHeight: '1.5' }],
        'ui-md': ['1rem', { lineHeight: '1', letterSpacing: '0' }],
        'ui-sm': ['0.875rem', { lineHeight: '1', letterSpacing: '0' }],
        'ui-xs': ['0.75rem', { lineHeight: '1', letterSpacing: '0' }],
      },
      spacing: {
        '4xs': '0.125rem',  
        '3xs': '0.25rem',   
